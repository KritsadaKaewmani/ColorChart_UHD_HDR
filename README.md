...
This script generates a Macbeth Color Checker chart in multiple color spaces:
sRGB
Display P3
...
Functionality:
It copies the color code values from the original Helen and John color chart.
It uses this data to create a full-frame EXR color chart in UHD size.
...
Wide Gamut Patches: The final row contains real-life color patches that fall outside the sRGB gamut but remain within the P3 gamut. This is used to verify the wide color gamut display capability of the output device.
